...
import { FileText, Lock, Layout, Zap, Check, ArrowRight } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 text-blue-700 px-4 py-1.5 rounded-full text-sm font-medium mb-8">
              ...
              v2.0 Now Supporting Gemini & Grok Exports
            </div>
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-slate-900 mb-6">
              Turn your AI chats into <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Professional Docs</span>
            </h1>
            <p className="text-xl text-slate-600 mb-10 leading-relaxed">
              Export conversations from ChatGPT, Claude, and Grok to beautifully formatted PDF and Word documents. Preserves code blocks, markdown, and tables.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                Start Converting Free <ArrowRight size={20} />
              </button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-12">
            <FeatureCard 
              ...
              description="We parse Markdown, code snippets, and tables to create polished documents ready for sharing."
            />
            <FeatureCard 
              icon={<Lock className="text-emerald-600" size={32} />}
              title="Enterprise Security"
              description="Powered by Firebase Security Rules. Your data is processed in ephemeral Cloud Functions and auto-deleted."
            />
            <FeatureCard 
              icon={<Zap className="text-amber-600" size={32} />}
              title="Instant Conversion"
              description="Drag, drop, done. Our serverless architecture scales to handle thousands of pages in seconds."
            />
          </div>
        </div>
      </div>
      ...
      <div className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-slate-900 rounded-3xl p-12 md:p-20 text-center relative overflow-hidden">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to organize your AI knowledge?</h2>
            <p className="text-slate-300 text-lg mb-10 max-w-2xl mx-auto">
              Join 10,000+ developers, writers, and researchers who use ChatExport Pro to archive their work.
            </p>
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center text-slate-300 text-sm font-medium mb-10">
              <span className="flex items-center gap-2"><Check className="text-green-400" size={16} /> No credit card required</span>
              <span className="flex items-center gap-2"><Check className="text-green-400" size={16} /> 5 Free conversions/day</span>
